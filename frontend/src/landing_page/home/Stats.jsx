    ...
    return (
        <div className="container p-3">
            <div className="row p-5">
                ...
                <div className="col-6 p-5">
                    <img src="media/images/ecosystem.png" alt="Zerodha_ecosystem" className="img-fluid" style={{ width: "90%" }} />
...
// It's not recommended to use h3 after using h1 with no usage of h2 